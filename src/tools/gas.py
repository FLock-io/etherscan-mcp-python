...
def register_gas_tools(server: FastMCP) -> None:
    ...
    @server.tool()
    def gas_gasestimate(gasprice: str, chainid: str = "8453") -> str:
    ...
    @server.tool()
    def gas_gasoracle(chainid: str = "8453") -> str:
    ...
    @server.tool()
    def stats_dailyavggaslimit(startdate: str, enddate: str, sort: str, chainid: str = "8453") -> str:
