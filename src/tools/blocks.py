...
def register_block_tools(server: FastMCP) -> None:
    ...
    @server.tool()
    def block_getblockreward(blockno: str, chainid: str = "8453") -> str:
    ...
    @server.tool()
    def block_getblockcountdown(blockno: str, chainid: str = "8453") -> str:
    ...
    @server.tool()
    def block_getblocknobytime(timestamp: str, closest: str, chainid: str = "8453") -> str:
    ...
    @server.tool()
    def block_getblocktxnscount(blockno: str, chainid: str = "8453") -> str:
