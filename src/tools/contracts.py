...
def register_contract_tools(server: FastMCP) -> None:
    ...
    @server.tool()
    def contract_getabi(address: str, chainid: str = "8453") -> str:
    ...
    @server.tool()
    def contract_getsourcecode(address: str, chainid: str = "8453") -> str:
    ...
    @server.tool()
    def contract_getcontractcreation(contractaddresses: str, chainid: str = "8453") -> str:
    ...
    @server.tool()
    def contract_checkverifystatus(guid: str, chainid: str = "8453") -> str:
